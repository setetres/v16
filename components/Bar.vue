<template>
  <nav class="col-span-2 bg-emerald-200 uppercase" aria-label="Breadcrumb">
    <ol role="list" class="flex w-full justify-between">
      <li class="flex pattern px-6 py-1 rounded-lg">
      ...
      <li class="flex border-r border-zinc-900 rounded-b-lg">
        <div class="flex items-center">
          <NuxtLink
            ...
            :class="color + ' px-6 py-6 text-gray-700 focus-within:ring-2 focus-within:ring-inset focus-within:ring-white rounded-tr-lg'">
