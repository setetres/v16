<template>
  <div class="relative group bg-emerald-200 p-2 focus-within:ring-2 focus-within:ring-inset focus-within:ring-white col-span-2">
    <span class="rounded-lg flex text-gray-700 overflow-hidden">
      <slot />
    </span>
    <div class="mt-6">
      <HeadingSans>
      ...
      >
        ...
        <HeadingSerif :class="color + ' text-2xl'">
          {{ title }}
        </HeadingSerif>
      </NuxtLink>
    ...
    <span v-if="external" class="pointer-events-none absolute top-6 right-6 text-zinc-400 group-hover:text-gray-700" aria-hidden="true">
